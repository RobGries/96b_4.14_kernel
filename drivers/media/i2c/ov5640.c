...
//0x5308 was 0x75 :: CIP EDGE MT (manual tuning) =1 
static const struct reg_value ov5640_init_setting_30fps_VGA[] = {
	...
	{0x5307, 0x2c, 0, 0}, {0x5308, 0x05, 0, 0}, {0x5309, 0x08, 0, 0}, 
	{0x530a, 0x30, 0, 0},
...
static const struct reg_value ov5640_init_cwf_LENC_setting_30fps_VGA[] = {
	...
	{0x5490, 0x1d, 0, 0}, {0x5580, 0x02, 0, 0}, {0x5583, 0x40, 0, 0},
	{0x5584, 0x10, 0, 0}, {0x5589, 0x10, 0, 0}, {0x558a, 0x00, 0, 0},
	{0x558b, 0xf8, 0, 0}, {0x5800, 0x14, 0, 0}, {0x5801, 0x0e, 0, 0}, 
...
static const struct reg_value ov5640_init_cwf2_LENC_setting_30fps_VGA[] = {
	{0x3103, 0x11, 0, 0}, {0x3008, 0x82, 0, 5}, {0x3008, 0x42, 0, 0},
	{0x3103, 0x03, 0, 0}, {0x3017, 0x00, 0, 0}, {0x3018, 0x00, 0, 0},
	{0x3630, 0x36, 0, 0},
	{0x3631, 0x0e, 0, 0}, {0x3632, 0xe2, 0, 0}, {0x3633, 0x12, 0, 0},
	...
	{0x5490, 0x1d, 0, 0}, {0x5580, 0x02, 0, 0}, {0x5583, 0x40, 0, 0},
	{0x5584, 0x10, 0, 0}, {0x5589, 0x10, 0, 0}, {0x558a, 0x00, 0, 0},
	{0x558b, 0xf8, 0, 0}, {0x5800, 0x2e, 0, 0}, {0x5801, 0x1a, 0, 0}, 
	{0x5802, 0x14, 0, 0}, {0x5803, 0x14, 0, 0}, {0x5804, 0x1d, 0, 0}, 
	{0x5805, 0x35, 0, 0}, {0x5806, 0x0f, 0, 0}, {0x5807, 0x07, 0, 0}, 
	{0x5808, 0x03, 0, 0}, {0x5809, 0x03, 0, 0}, {0x580a, 0x08, 0, 0}, 
	{0x580b, 0x11, 0, 0}, {0x580c, 0x08, 0, 0}, {0x580d, 0x01, 0, 0}, 
	{0x580e, 0x00, 0, 0}, {0x580f, 0x00, 0, 0}, {0x5810, 0x01, 0, 0}, 
	{0x5811, 0x09, 0, 0}, {0x5812, 0x07, 0, 0}, {0x5813, 0x01, 0, 0}, 
	{0x5814, 0x00, 0, 0}, {0x5815, 0x00, 0, 0}, {0x5816, 0x01, 0, 0}, 
	{0x5817, 0x09, 0, 0}, {0x5818, 0x0e, 0, 0}, {0x5819, 0x06, 0, 0}, 
	{0x581a, 0x02, 0, 0}, {0x581b, 0x02, 0, 0}, {0x581c, 0x06, 0, 0}, 
	{0x581d, 0x0f, 0, 0}, {0x581e, 0x2d, 0, 0}, {0x581f, 0x17, 0, 0},
	{0x5820, 0x12, 0, 0}, {0x5821, 0x13, 0, 0}, {0x5822, 0x19, 0, 0},
	{0x5823, 0x36, 0, 0}, {0x5824, 0xbb, 0, 0}, {0x5825, 0x66, 0, 0}, 
	{0x5826, 0x55, 0, 0}, {0x5827, 0x66, 0, 0}, {0x5828, 0x9b, 0, 0}, 
	{0x5829, 0x43, 0, 0}, {0x582a, 0x21, 0, 0}, {0x582b, 0x21, 0, 0}, 
	{0x582c, 0x31, 0, 0}, {0x582d, 0x54, 0, 0}, {0x582e, 0x00, 0, 0}, 
	{0x582f, 0x42, 0, 0}, {0x5830, 0xa6, 0, 0}, {0x5831, 0x63, 0, 0}, 
	{0x5832, 0x22, 0, 0}, {0x5833, 0x54, 0, 0}, {0x5834, 0x42, 0, 0}, 
	{0x5835, 0x53, 0, 0}, {0x5836, 0x53, 0, 0}, {0x5837, 0x65, 0, 0}, 
	{0x5838, 0xac, 0, 0}, {0x5839, 0x78, 0, 0}, {0x583a, 0x66, 0, 0}, 
	{0x583b, 0x88, 0, 0}, {0x583c, 0xaa, 0, 0}, {0x583d, 0xac, 0, 0},
	{0x5025, 0x00, 0, 0}, {0x3a0f, 0x30, 0, 0}, {0x3a10, 0x28, 0, 0},
	{0x3a1b, 0x30, 0, 0}, {0x3a1e, 0x26, 0, 0}, {0x3a11, 0x60, 0, 0},
	{0x3a1f, 0x14, 0, 0}, {0x3008, 0x02, 0, 0}, {0x3c00, 0x04, 0, 300},
};
...
//ov5640_init_cwf_LENC_setting_30fps_VGA
...
//ov5640_init_cwf2_LENC_setting_30fps_VGA
static const struct ov5640_mode_info ov5640_mode_cwf2_LENC_init_data = {
	0, SUBSAMPLING, 640, 1896, 480, 984,
	ov5640_init_cwf2_LENC_setting_30fps_VGA,
	ARRAY_SIZE(ov5640_init_cwf2_LENC_setting_30fps_VGA),
};
...
static int ov5640_set_mode(struct ov5640_dev *sensor)
{
	...
	if (ret < 0) {
		...
		printk(KERN_INFO "[*] ov5640: Write to 0x5306 denoise val"); 
	}
...
static int ov5640_restore_mode(struct ov5640_dev *sensor)
{
	...
	switch (init_regs) {
		...
		case 2 : 
			printk(KERN_INFO "[*] ov5640: Using OV5640 cwf_LENC_setting.txt reg map");
			active_regs = &ov5640_mode_cwf2_LENC_init_data;
			break;
		default :
			printk(KERN_INFO "[*] ov5640: Using Stock init reg map");
			active_regs = &ov5640_mode_init_data;
